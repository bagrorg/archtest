...
import model.ShivaServiceMap._

import io.circe.Decoder
import io.circe.generic.extras.Configuration
import io.circe.generic.extras.semiauto.deriveConfiguredDecoder

case class ShivaServiceMap(
    name: String,
    description: String,
    owners: List[String],
    aYaml: Option[AYaml],
...
object ShivaServiceMap {
  ...
  implicit val decoderShivaServiceMap: Decoder[ShivaServiceMap] = deriveConfiguredDecoder
}

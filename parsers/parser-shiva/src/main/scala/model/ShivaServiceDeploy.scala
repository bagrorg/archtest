...
import model.ShivaServiceDeploy._

import io.circe.Decoder
import io.circe.generic.extras.Configuration
import io.circe.generic.extras.semiauto.deriveConfiguredDecoder

case class ShivaServiceDeploy(
    name: String,
    image: Option[String],
...
object ShivaServiceDeploy {
  ...
  implicit val decoderShivaServiceDeploy: Decoder[ShivaServiceDeploy] = deriveConfiguredDecoder
}
